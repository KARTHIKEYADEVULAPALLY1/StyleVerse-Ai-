...
class Product(Base):
    ...
    target_gender: Mapped[str | None] = mapped_column(String(50), nullable=True, default='Unisex')
    ...
    normalized_colors: Mapped[List[str]] = mapped_column(JSON, default=list, nullable=False)
